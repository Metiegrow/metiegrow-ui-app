...
// };
  ...
  const remainingSkillsCount = alumniprofiledetails.skills ?  alumniprofiledetails.skills.length - 3 : 0;
  ...
  return (
    <div  className='mentor-profile'>
      <div className=''>
        ...
        <Colxx sm="12" md="12" lg="12" xxs="12" className=''>
          ...
          <div className=' '>
            {alumniprofiledetails.imageUrl === null?(
              ...
              <img src={`${baseUrl}/${alumniprofiledetails.imageUrl}`} 
            ...
            <Button color="light" className=" font-weight-semibold mx-2" size='large'>
                <span className='font-weight-semibold text-one'><i className='iconsminds-thunder text-primary'/>{alumniprofiledetails.achievement}</span>
              </Button>
            </div>
          ...
          <h1 className='font-weight-semibold text-xlarge'>{alumniprofiledetails.firstName} {alumniprofiledetails.lastName}</h1>
         
          <h3 className='text-large  text-muted  '>{alumniprofiledetails.jobTitle}</h3>
            <h2 className='text-one  text-primary'>{alumniprofiledetails.company}</h2>
            <p  className='text-one font-weight-medium text-primary'>{alumniprofiledetails.bio}</p>
            
            <h5 className='font-weight-medium'><i className='simple-icon-location-pin text-primary'/><span className='ml-2'>{alumniprofiledetails.location}</span></h5>
          ...
          <div className='col-7 mt-4'>
            ...
            {alumniprofiledetails.skills && alumniprofiledetails.skills.slice(0, 3).map((skill) => (
            <div key={skill}>
        ...
        {alumniprofiledetails.skills && alumniprofiledetails.skills.length > 3 && (
          <div className=''>
          ...
          <Colxx className='sm="12" md="12" lg="12" xxs="12" mt-5'>
            ...
            <p className='text-one font-weight-medium '>{alumniprofiledetails.bio}</p>
            </div>
        ...
        <h1 className='font-weight-semibold text-large'>Skills </h1>
            <div className='d-flex flex-wrap '>
              {alumniprofiledetails.skills && alumniprofiledetails.skills.map((skill) => (
                <div key={skill}>
              <Button color="light" className="mb-2 font-weight-semibold mr-2"
               size='md'>
                {skill}
              </Button>
            </div>
        ...
        <ReviewsComponent
        category="alumni"  // for lawyer profile "law"
        revieweeId ={mid}
        />
      </div>
    </div>
